      ...
      <main className="flex-1 max-w-md mx-auto w-full px-4 py-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="relative my-6">
            ...
            <span className="relative flex justify-center text-xs text-[#A89888]">
              or
            </span>
          </div>
          <button
            ...
            className="w-full rounded-xl bg-[#550015] border border-[#800022]/40 text-[#F5F0E8] py-3.5 font-medium hover:bg-[#800022]/30 transition-colors disabled:opacity-60 flex items-center justify-center gap-2"
          >
